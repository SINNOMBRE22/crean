...
```bash
curl -sSL https://raw.githubusercontent.com/SINNOMBRE22/crean/main/clean -o /usr/local/bin/clean && chmod +x /usr/local/bin/clean
```
...
MIT — libre de usar, modificar y redistribuir. Ver [LICENSE](LICENSE).
